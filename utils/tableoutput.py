...
if __name__ == '__main__':
    ...
    print to.indent([labels]+rows, hasHeader=True)
    # test indent with different wrapping functions
    width = 10
    for wrapper in (to.wrap_always,to.wrap_onspace,to.wrap_onspace_strict):
        print 'Wrapping function: %s(x,width=%d)\n' % (wrapper.__name__,width)
        print to.indent([labels]+rows, hasHeader=True, separateRows=True,
                     prefix='| ', postfix=' |',
